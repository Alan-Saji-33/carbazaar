...
<head>
    ...
    <title>Register as Buyer - CarBazaar</title>
    ...
    <style>
        ...
        /* Auth Container Styles (Enhanced to Match register.php) */
        .auth-container {
            display: flex;
            max-width: 900px;
            margin: 50px auto;
        ...
        <div class="auth-container">
            ...
            <div class="auth-form-container">
                <div class="auth-header">
                    ...
                    <p>Join CarBazaar to find your dream car</p>
                </div>
                ...
                <form method="POST">
                    ...
                    <div class="form-footer">
                        <p>Want to sell instead? <a href="seller.php">Register as Seller</a></p>
