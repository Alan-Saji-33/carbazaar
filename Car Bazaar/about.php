...
<head>
    ...
    <style>
        ...
        /* Header Styles (Provided, Unchanged) */
        header {
        ...
        <div class="about-content">
            ...
            <section class="policy-container" id="privacy-policy">
                ...
                <ul>
                    ...
                    <li>Used solely for platform operations, such as verification and communication.</li>
                    <li>Never shared with third parties without consent, except as required by law.</li>
                    <li>Accessible and editable via your profile settings.</li>
                </ul>
            ...
            <section class="policy-container" id="terms-conditions">
                ...
                <ul>
                    ...
                    <li>Accept that CarBazaar is not liable for disputes arising from transactions between buyers and sellers.</li>
                </ul>
            ...
            <section class="policy-container" id="how-to-sell">
                ...
                <ol>
                    <li><strong>Register as a Seller</strong>: Sign up and complete Aadhaar verification.</li>
                    <li><strong>List Your Car</strong>: Add details like brand, model, price, and upload clear photos.</li>
                    <li><strong>Connect with Buyers</strong>: Respond to inquiries via the platform.</li>
                    <li><strong>Close the Deal</strong>: Finalize the sale securely with our support.</li>
                </ol>
            ...
            <section class="policy-container" id="buyer-guide">
                ...
                <ul>
                    <li><strong>Browse Listings</strong>: Use filters to find cars by brand, price, or location.</li>
                    <li><strong>Check Details</strong>: Review car specs and seller verification status.</li>
                    <li><strong>Contact Seller</strong>: Reach out to discuss details or schedule a test drive.</li>
                    <li><strong>Secure Payment</strong>: Use trusted payment methods and verify all documents before finalizing.</li>
                </ul>
